...
class VQVAETransformerInferer(Inferer):
    ...
    def sample(
        ...
        print("The latent spatial dimension in sampling function :",latent_spatial_dim)
        ...
        print(f"latent_seq.shape: {latent_seq.shape}")
        print(f"starting_tokens.shape: {starting_tokens.shape}")
        print(f"latent_spatial_dim: {latent_spatial_dim}")
